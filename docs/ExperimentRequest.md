...
**promotions** | [**java.util.List&lt;Promotion&gt;**](Promotion.md) | The promotions to consider active when running the search.  Provided promotions override existing promotions with the same ID. |  [optional]
