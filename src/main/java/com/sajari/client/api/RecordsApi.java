...
import com.sajari.client.model.BatchUpdateRecordsRequest;
import com.sajari.client.model.BatchUpdateRecordsResponse;
...
public class RecordsApi {
    ...
    /**
     * Build call for batchUpdateRecords
     ...
     */
    public okhttp3.Call batchUpdateRecordsCall(String collectionId, BatchUpdateRecordsRequest batchUpdateRecordsRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = batchUpdateRecordsRequest;

        // create path and map variables
        String localVarPath = "/v4/collections/{collection_id}/records:batchUpdate"
    ...
    private okhttp3.Call batchUpdateRecordsValidateBeforeCall(String collectionId, BatchUpdateRecordsRequest batchUpdateRecordsRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'collectionId' is set
        if (collectionId == null) {
            throw new ApiException("Missing the required parameter 'collectionId' when calling batchUpdateRecords(Async)");
        }
        
        // verify the required parameter 'batchUpdateRecordsRequest' is set
        if (batchUpdateRecordsRequest == null) {
            throw new ApiException("Missing the required parameter 'batchUpdateRecordsRequest' when calling batchUpdateRecords(Async)");
        }
        

        okhttp3.Call localVarCall = batchUpdateRecordsCall(collectionId, batchUpdateRecordsRequest, _callback);
        return localVarCall;
     ...
     */
    public BatchUpdateRecordsResponse batchUpdateRecords(String collectionId, BatchUpdateRecordsRequest batchUpdateRecordsRequest) throws ApiException {
        ApiResponse<BatchUpdateRecordsResponse> localVarResp = batchUpdateRecordsWithHttpInfo(collectionId, batchUpdateRecordsRequest);
     ...
     */
    public ApiResponse<BatchUpdateRecordsResponse> batchUpdateRecordsWithHttpInfo(String collectionId, BatchUpdateRecordsRequest batchUpdateRecordsRequest) throws ApiException {
        okhttp3.Call localVarCall = batchUpdateRecordsValidateBeforeCall(collectionId, batchUpdateRecordsRequest, null);
        Type localVarReturnType = new TypeToken<BatchUpdateRecordsResponse>(){}.getType();
     ...
     */
    public okhttp3.Call batchUpdateRecordsAsync(String collectionId, BatchUpdateRecordsRequest batchUpdateRecordsRequest, final ApiCallback<BatchUpdateRecordsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = batchUpdateRecordsValidateBeforeCall(collectionId, batchUpdateRecordsRequest, _callback);
        Type localVarReturnType = new TypeToken<BatchUpdateRecordsResponse>(){}.getType();
     ...
     */
    public okhttp3.Call updateRecordCall(String collectionId, UpdateRecordRequest updateRecordRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        Object localVarPostBody = updateRecordRequest;

        // create path and map variables
        String localVarPath = "/v4/collections/{collection_id}/records:update"
            .replaceAll("\\{" + "collection_id" + "\\}", localVarApiClient.escapeString(collectionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateRecordValidateBeforeCall(String collectionId, UpdateRecordRequest updateRecordRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'collectionId' is set
        if (collectionId == null) {
            throw new ApiException("Missing the required parameter 'collectionId' when calling updateRecord(Async)");
        }
        
        // verify the required parameter 'updateRecordRequest' is set
        if (updateRecordRequest == null) {
            throw new ApiException("Missing the required parameter 'updateRecordRequest' when calling updateRecord(Async)");
        }
        

        okhttp3.Call localVarCall = updateRecordCall(collectionId, updateRecordRequest, _callback);
        return localVarCall;
     ...
     */
    public Object updateRecord(String collectionId, UpdateRecordRequest updateRecordRequest) throws ApiException {
        ApiResponse<Object> localVarResp = updateRecordWithHttpInfo(collectionId, updateRecordRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> updateRecordWithHttpInfo(String collectionId, UpdateRecordRequest updateRecordRequest) throws ApiException {
        okhttp3.Call localVarCall = updateRecordValidateBeforeCall(collectionId, updateRecordRequest, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateRecordAsync(String collectionId, UpdateRecordRequest updateRecordRequest, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateRecordValidateBeforeCall(collectionId, updateRecordRequest, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
